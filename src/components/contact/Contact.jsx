        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center min-h-[60vh]'>
          <div className="flex justify-center md:justify-end md:pr-10">
            <div className="mx-auto max-w-2xl text-center md:text-left">
              <h2 className="hov tracking-tight inline-box font-semibold from-[#5EA2EF] to-[#0072F5] text-4xl lg:text-6xl bg-clip-text text-transparent bg-linear-to-b [text-shadow:_0_3px_0_rgb(0_0_0_/_10%)]">
                Contact Us
              </h2>
              <p className="hov mt-4 text-lg text-slate-600">
